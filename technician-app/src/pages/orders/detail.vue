    ...
    <view v-else-if="order" class="detail-wrap">
        ...
        <view class="media-block" v-if="order.before_photos">
          ...
          <view class="media-grid">
            <view v-for="(p,i) in parsePhotos(order.before_photos)" :key="i" class="media-item" @click="previewImage(p)">
              <image :src="p" mode="aspectFill" class="media-img"></image>
            </view>
          </view>
        </view>
      ...
      <view class="section-card" v-if="order.status==='in_progress'">
        ...
        <view class="media-block">
          ...
          <view class="media-grid">
            <view v-for="(p,i) in captureBefore" :key="i" class="media-item"><image :src="p" mode="aspectFill" class="media-img"></image><text class="media-del" @click="captureBefore.splice(i,1)">✕</text></view>
        ...
        <view class="media-block">
          ...
          <view class="media-grid">
            <view v-for="(p,i) in captureAfter" :key="i" class="media-item"><image :src="p" mode="aspectFill" class="media-img"></image><text class="media-del" @click="captureAfter.splice(i,1)">✕</text></view>
      ...
      <view class="modal-overlay" v-if="showTransfer" @click="showTransfer=false">
        <view class="rmodal" @click.stop>
          ...
          <scroll-view scroll-y style="max-height:320px;margin-bottom:12px" v-else>
            <view
